...
if not st.session_state.authenticated:
    ...
    # About Page
        ...
        with col2:
            st.image("images/author2.jpg", width=150, caption="UX Designer")
            st.write("""
            **K.Pugazhmani**  
            Devloper Front End  
        ...
        📧 support@churnpredictorpro.com  
        📚 [Documentation](https://docs.churnpredictorpro.com)  
        👥 [Community](https://community.churnpredictorpro.com)
        """)
        ...
        st.write("""
        Version 1.0.0  
        © 2024 ChurnPredictorPro. All rights reserved.
        """)
